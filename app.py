...
# Configure app
app = Flask(__name__)
app.secret_key='flask24600f43ed984a23a27175928c15c6c934693a9fe6716f3a5d671d82b06df051'
...
def on_leave(data):
    ...
    def internal_server_error(e):
      return "Internal Server Error. Please check the logs for more information.", 500
